    ...
    <div class="container-fluid border border-success bg-light">
        ...
        <?php
            if (isset($_GET['action']) == 'delete') {
                ...
                $query = mysqli_query($conn, "SELECT * FROM incidentes WHERE id='$id_delete'");
                if (mysqli_num_rows($query) == 0) {
                    echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> No se encontraron datos.</div>';
                } else {
                    $delete = mysqli_query($conn, "DELETE FROM incidentes WHERE id='$id_delete'");
                    if ($delete) {
            ...
            <div class="panel-body">
                <div class="justify-content-end">
                    <a href="registro.php" class="btn btn-sm btn-success"><i class="bi bi-plus-circle-fill"></i>
                        Registrar incidentes</a>
                    <a href="../index.php" class="btn btn-sm btn-success"><i class="bi bi-person-fill"></i> Base
                        de datos</a>
                    <a href="../graficas/graficaIncidentes.php" class="btn btn-sm btn-success"><i class="bi bi-graph-up"></i> Ver
                        graficas</a>
                    ...
                    <a onclick="loadDataTarea('bi bi-book',' Tareas','incidentes')" class="btn btn-sm btn-success" href="" data-bs-toggle="modal" data-bs-target="#mimodal">
                ...
                <div class="table-responsive">
                    <table id="table" class="table table-bordered border-success table-striped text-center">
                        ...
                        <tbody class="Ausentismos">
                            <?php include_once 'incidentes.php' ?>
                        </tbody>
                    </table>
                </div>
