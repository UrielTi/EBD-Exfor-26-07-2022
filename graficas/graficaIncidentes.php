...
<head>
	<?php include("head.php");
        ...
        //Lista de consultas a la tabla de la base de datos llamada incidentes
        
        /*Consultas al nombre con dias de incapacidad y 
        un contador de cuantas veces se accidenta la misma persona*/
        $result = mysqli_query($conn, "SELECT nombres, sum(dias_incapacidad) AS dias FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY nombres ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $resultCont = mysqli_query($conn, "SELECT nombres, COUNT(nombres) AS cont FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY nombres ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));

        /*Consultas al cargo con dias de incapacidad y 
        un contador de cuantas veces se accidenta por el mismo cargo*/
        $result1 = mysqli_query($conn, "SELECT cargo, sum(dias_incapacidad) AS dias FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY cargo ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $result1Cont = mysqli_query($conn, "SELECT cargo, COUNT(cargo) AS cont FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY cargo ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));

        /*Consultas al proceso con dias de incapacidad y 
        un contador de cuantas veces se accidenta por el mismo proceso*/
        $result2 = mysqli_query($conn, "SELECT proceso, sum(dias_incapacidad) AS dias FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY proceso ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $result2Cont = mysqli_query($conn, "SELECT proceso, count(proceso) AS cont FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY proceso ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));

        /*Consultas al supervisor con dias de incapacidad y 
        un contador de cuantas veces se accidenta con el mismo supervisor*/
        $result3 = mysqli_query($conn, "SELECT supervisor, SUM(dias_incapacidad) AS dias FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY supervisor ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $result3Cont = mysqli_query($conn, "SELECT supervisor, COUNT(supervisor) AS cont FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY supervisor ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));

        /*Consultas al evento con dias de incapacidad y 
        un contador de cuantos incidentes hay por el mismo evento*/
        $result4 = mysqli_query($conn, "SELECT evento, SUM(dias_incapacidad) AS dias FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY evento ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $result4Cont = mysqli_query($conn, "SELECT evento, COUNT(evento) AS cont FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY evento ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));

        /*Consultas al nucleo con dias de incapacidad y 
        un contador de cuantas veces se accidenta por el nucleo*/
        $result5 = mysqli_query($conn, "SELECT nucleo, SUM(dias_incapacidad) AS dias FROM incidentes WHERE fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY nucleo ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $result5Cont = mysqli_query($conn, "SELECT nucleo, COUNT(nucleo) AS cont FROM incidentes WHERE fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY nucleo ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));

        /*Consultas al dia con dias de incapacidad y 
        un contador de cuantas veces se accidenta por el dia */
        $result6 = mysqli_query($conn, "SELECT dia, SUM(dias_incapacidad) AS dias FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY dia ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $result6Cont = mysqli_query($conn, "SELECT dia, COUNT(dia) AS cont FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY dia ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));

        /*Consultas a la hora con dias de incapacidad y 
        un contador de cuantas veces se accidenta a la misma hora*/
        $result7 = mysqli_query($conn, "SELECT hora, SUM(dias_incapacidad) AS dias FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY hora ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $result7Cont = mysqli_query($conn, "SELECT hora, COUNT(hora) AS cont FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY hora ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));
        
        /*Consultas al mes con dias de incapacidad y 
        un contador de cuantas veces se accidenta por mes del envento*/
        $result8 = mysqli_query($conn, "SELECT mes, SUM(dias_incapacidad) AS dias FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY mes ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $result8Cont = mysqli_query($conn, "SELECT mes, COUNT(mes) AS cont FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY mes ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));

        /*Consultas al año con dias de incapacidad y 
        un contador de cuantas veces se accidentan por año*/
        $result9 = mysqli_query($conn, "SELECT año, SUM(dias_incapacidad) AS dias FROM incidentes WHERE nucleo='$nucleo' GROUP BY año ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $result9Cont = mysqli_query($conn, "SELECT año, COUNT(año) AS cont FROM incidentes WHERE nucleo='$nucleo' GROUP BY año ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));

        /*Consultas a la finca con dias de incapacidad y 
        un contador de cuantas veces se accidenta en la misma finca*/
        $result10 = mysqli_query($conn, "SELECT finca, SUM(dias_incapacidad) AS dias FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY finca ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $result10Cont = mysqli_query($conn, "SELECT finca, COUNT(finca) AS cont FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY finca ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));
        ...
        $result11 = mysqli_query($conn, "SELECT peligro, SUM(dias_incapacidad) AS dias FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY peligro ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $result11Cont = mysqli_query($conn, "SELECT peligro, COUNT(peligro) AS cont FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY peligro ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));

        /*Consultas al mecanismo con dias de incapacidad y 
        un contador de cuantas veces se accidenta por el mismo mecanismo*/
        $result12 = mysqli_query($conn, "SELECT mecanismo, SUM(dias_incapacidad) AS dias FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY mecanismo ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $result12Cont = mysqli_query($conn, "SELECT mecanismo, COUNT(mecanismo) AS cont FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY mecanismo ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));
        ...
        $result13 = mysqli_query($conn, "SELECT agente_lesion, SUM(dias_incapacidad) AS dias FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY agente_lesion ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $result13Cont = mysqli_query($conn, "SELECT agente_lesion, COUNT(agente_lesion) AS cont FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY agente_lesion ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));
        ...
        $result14 = mysqli_query($conn, "SELECT tipo_lesion, SUM(dias_incapacidad) AS dias FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY tipo_lesion ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $result14Cont = mysqli_query($conn, "SELECT tipo_lesion, COUNT(tipo_lesion) AS cont FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY tipo_lesion ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));
        ...
        $result15 = mysqli_query($conn, "SELECT parte_afectada, SUM(dias_incapacidad) AS dias FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY parte_afectada ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $result15Cont = mysqli_query($conn, "SELECT parte_afectada, COUNT(parte_afectada) AS cont FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY parte_afectada ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));

        /*Consultas al lugar con dias de incapacidad y 
        un contador de cuantas veces se accidenta en el mismo lugar */
        $result16 = mysqli_query($conn, "SELECT lugar, SUM(dias_incapacidad) AS dias FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY lugar ORDER BY dias DESC") or die("Error in Selecting " . mysqli_error($conn));
        $result16Cont = mysqli_query($conn, "SELECT lugar, COUNT(lugar) AS cont FROM incidentes WHERE nucleo='$nucleo' and fecha_inicio BETWEEN '$fecha1' AND '$fecha2' GROUP BY lugar ORDER BY cont DESC") or die("Error in Selecting " . mysqli_error($conn));
    ...
    <script type="text/javascript">
        function drawChart() {
            ...
            var options = {
                title: "Dias de incidentes por persona",
                is3D: true,
                width: "100%",
                height: 450,
            ...
            var options1 = {
                title: "Contador de incidentes por persona",
                is3D: true,
                width: "100%",
                height: 450,
            ...
            var options = {
                title: "Dias de incidentes por cargo",
                is3D: true,
                width: "100%",
                height: 450
            };
            ...
            var options1 = {
                title: "Contador de incidentes por cargo",
                is3D: true,
                width: "100%",
                height: 450,            
            };
            ...
            var options = {
                title: "Dias de incidentes por proceso",
                is3D: true,
                width: "100%",
                height: 450
            };
            ...
            var options1 = {
                title: "Contador de incidentes por proceso",
                is3D: true,
                width: "100%",
                height: 450,            
            };
            ...
            var options = {
                title: "Dias de incidentes por supervisor",
                is3D: true,
                width: "100%",
                height: 450
            };
            ...
            var options1 = {
                title: "Contador de incidentes por supervisor",
                is3D: true,
                width: "100%",
                height: 450,            
            };
            ...
            var options = {
                title: "Dias de incidentes por evento",
                is3D: true,
                width: "100%",
                height: 450
            };
            ...
            var options1 = {
                title: "Contador de incidentes por evento",
                is3D: true,
                width: "100%",
                height: 450,            
            };
            ...
            var options = {
                title: "Dias de incidentes por nucleo",
                is3D: true,
                width: "100%",
                height: 450
            };
            ...
            var options1 = {
                title: "Contador de incidentes por nucleo",
                is3D: true,
                width: "100%",
                height: 450,            
            };
            ...
            var options = {
                title: "Dias de incidentes por Dia",
                is3D: true,
                width: "100%",
                height: 450
            };
            ...
            var options1 = {
                title: "Contador de incidentes por dia",
                is3D: true,
                width: "100%",
                height: 450,            
            };
            ...
            var options = {
                title: "Dias de incidentes por hora",
                is3D: true,
                width: "100%",
                height: 450
            };
            ...
            var options1 = {
                title: "Contador de incidentes por hora",
                is3D: true,
                width: "100%",
                height: 450,            
            };
            ...
            var options = {
                title: "Dias de incidentes por mes",
                is3D: true,
                width: "100%",
                height: 450
            };
            ...
            var options1 = {
                title: "Contador de incidentes por mes",
                is3D: true,
                width: "100%",
                height: 450,            
            };
            ...
            var options = {
                title: "Dias de incidentes por año",
                is3D: true,
                width: "100%",
                height: 450
            };
            ...
            var options1 = {
                title: "Contador de incidentes por año",
                is3D: true,
                width: "100%",
                height: 450,            
            };
            ...
            var options = {
                title: "Dias de incidentes por finca",
                is3D: true,
                width: "100%",
                height: 450
            };
            ...
            var options1 = {
                title: "Contador de incidentes por finca",
                is3D: true,
                width: "100%",
                height: 450,            
            };
            ...
            var options = {
                title: "Dias de incidentes por peligro",
                is3D: true,
                width: "100%",
                height: 450
            };
            ...
            var options1 = {
                title: "Contador de incidentes por peligro",
                is3D: true,
                width: "100%",
                height: 450,            
            };
            ...
            var options = {
                title: "Dias de incidentes por mecanismo",
                is3D: true,
                width: "100%",
                height: 450
            };
            ...
            var options1 = {
                title: "Contador de incidentes por mecanismo",
                is3D: true,
                width: "100%",
                height: 450,            
            };
            ...
            var options = {
                title: "Dias de incidentes por agente de lesion",
                is3D: true,
                width: "100%",
                height: 450
            };
            ...
            var options1 = {
                title: "Contador de incidentes por agente de lesion",
                is3D: true,
                width: "100%",
                height: 450,            
            };
            ...
            var options = {
                title: "Dias de incidentes por tipo de lesion",
                is3D: true,
                width: "100%",
                height: 450
            };
            ...
            var options1 = {
                title: "Contador de incidentes por tipo de lesion",
                is3D: true,
                width: "100%",
                height: 450,            
            };
            ...
            var options = {
                title: "Dias de incidentes por parte afectada",
                is3D: true,
                width: "100%",
                height: 450
            };
            ...
            var options1 = {
                title: "Contador de incidentes por parte afectada",
                is3D: true,
                width: "100%",
                height: 450,            
            };
            ...
            var options = {
                title: "Dias de incidentes por lugar",
                is3D: true,
                width: "100%",
                height: 450
            };
            ...
            var options1 = {
                title: "Contador de incidentes por lugar",
                is3D: true,
                width: "100%",
                height: 450,            
            };
    ...
    <div class="container-fluid border border-success bg-light">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title"><i class="bi bi-person-plus-fill"></i> Graficas de incidentes</h4>
            </div>

            <!-- Formulario para las consultas segun las fechas indicadas -->
            <form name="graficaFechas" id="graficaFechas" class="form-horizontal row-fluid" method="POST" action="graficaIncidentes.php">
                
                <div class="control-group">
                    <div class="controls">
                        <a href="../incidentes/index.php" class="btn btn-sm btn-danger"><i class="bi bi-arrow-left"></i>
                            Regresar</a>
                    </div>
                </div>
                <hr>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                            Mostrar grafica de incidentalidad por persona
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                            Mostrar grafica de incidentalidad por cargo
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                            Mostrar grafica de incidentalidad por proceso
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingFour">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
                            Mostrar grafica de incidentalidad por supervisor
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingFive">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="true" aria-controls="collapseFive">
                            Mostrar grafica de incidentalidad por evento
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingSix">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix">
                            Mostrar grafica de incidentalidad por nucleo
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingSeven">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="true" aria-controls="collapseSeven">
                            Mostrar grafica de incidentalidad por dia
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingEight">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEight" aria-expanded="true" aria-controls="collapseEight">
                            Mostrar grafica de incidentalidad por hora
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingNine">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNine" aria-expanded="true" aria-controls="collapseNine">
                            Mostrar grafica de incidentalidad por mes de evento
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTen">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTen" aria-expanded="true" aria-controls="collapseTen">
                            Mostrar grafica de incidentalidad por año
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingEleven">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEleven" aria-expanded="true" aria-controls="collapseEleven">
                            Mostrar grafica de incidentalidad por finca
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwelve">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwelve" aria-expanded="true" aria-controls="collapseTwelve">
                            Mostrar grafica de incidentalidad por factor de riesgo o peligro asociado
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThirteen">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirteen" aria-expanded="true" aria-controls="collapseThirteen">
                            Mostrar grafica de incidentalidad por mecanismo
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingFourteen">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourteen" aria-expanded="true" aria-controls="collapseFourteen">
                            Mostrar grafica de incidentalidad por agente de lesion
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingFifteen">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFifteen" aria-expanded="true" aria-controls="collapseFifteen">
                            Mostrar grafica de incidentalidad por tipo de lesion
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingSixteen">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSixteen" aria-expanded="true" aria-controls="collapseSixteen">
                            Mostrar grafica de incidentalidad por parte afectada
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingSeventeen">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeventeen" aria-expanded="true" aria-controls="collapseSeventeen">
                            Mostrar grafica de incidentalidad por lugar
                        </button>
                    </h2>
