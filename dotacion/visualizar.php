...
<div class="panel panel-default">
    <form name="form1" id="form1" class="form-horizontal row-fluid" action="visualizar.php" method="GET">
        ...
        <div class="input-group shadow-sm">
            ...
            <input class="form-control" type="text" name="nombres" id="nombres" value="<?php echo $row['nombre']; ?>" readonly="readonly">
        </div>
        <hr>
        ...
        <div class="input-group shadow-sm">
            ...
            <input name="camisa" id="camisa" readonly required class="form-control" type="text" value="<?php echo $row['camisa'] ?>">
            <span class="input-group-text" for="pantalon">(*)Talla pantalon:</span>
            <input name="pantalon" id="pantalon" readonly required class="form-control" type="text" value="<?php echo $row['pantalon'] ?>">
        </div>
        <hr>
        <div class="input-group shadow-sm">
            <span class="input-group-text" for="botas">(*)Talla botas:</span>
            <input name="botas" id="botas" readonly required class="form-control" type="text" value="<?php echo $row['botas'] ?>">
            <span class="input-group-text" for="guayo">(*)Talla guayo:</span>
            <input name="guayo" id="guayo" readonly required class="form-control" type="text" value="<?php echo $row['guayo'] ?>">
        </div>
        <hr>
