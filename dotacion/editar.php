		...
		<div class="panel panel-default">
			...
			<form name="form1" id="form1" class="form-horizontal row-fluid" action="update-edit.php" method="POST">
				...
				<div class="input-group shadow-sm">
					...
					<input class="form-control" type="text" name="nombres" id="nombres" value="<?php echo $row['nombre']; ?>" readonly>
				</div>
				<hr>

				<div class="input-group shadow-sm">
					<span class="input-group-text w-25" id="cedula">(*) Cédula: </span>
					<input class="form-control" type="number" name="cedula" id="cedula" value="<?php echo $row['cedula']; ?>" readonly>
				</div>
				<hr>

				<div class="input-group shadow-sm">
					<label class="input-group-text w-25" for="nucleo">(*) Núcleo: </label>
					<input class="form-control" type="hidden" name="nucleo" id="nucleo" value="<?php echo $row['nucleo']; ?>" readonly>
					<input class="form-control" type="text" value="<?php echo $nucleos[$row['nucleo']] ?>" readonly>
				</div>
				<hr>

				<div class="input-group shadow-sm">
					<label class="input-group-text w-25" for="cargo">(*) Cargo: </label>
					<input class="form-control" type="hidden" name="cargo" id="cargo" value="<?php echo $row['cargo']; ?>" readonly>
					<input class="form-control" type="text" value="<?php echo $cargos[$row['cargo']] ?>" readonly>
				</div>
				<hr>

				<div class="input-group shadow-sm">
					<span class="input-group-text w-25" for="camisa">(*)Talla camisa:</span>
					<input name="camisa" id="camisa" required class="form-control" type="text" value="<?php echo $row['camisa'] ?>">
					<span class="input-group-text w-25" for="pantalon">(*)Talla pantalon:</span>
					<input name="pantalon" id="pantalon" required class="form-control" type="text" value="<?php echo $row['pantalon'] ?>">
				</div>
				<hr>
				<div class="input-group shadow-sm">
					<span class="input-group-text w-25" for="botas">(*)Talla botas:</span>
					<input name="botas" id="botas" required class="form-control" type="text" value="<?php echo $row['botas'] ?>">
					<span class="input-group-text w-25" for="guayo">(*)Talla guayo:</span>
					<input name="guayo" id="guayo" required class="form-control" type="text" value="<?php echo $row['guayo'] ?>">
				</div>
				<hr>
