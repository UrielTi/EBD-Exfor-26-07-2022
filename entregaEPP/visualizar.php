<?php 
    ...
    include("../cond/todo.php");
                    ...
                    <div class="panel panel-default">
                        <form name="form1" id="form1" class="form-horizontal row-fluid" action="visualizar.php"
                            ...
                            <div class="input-group shadow-sm">
                                ...
                                <input name="nucleo" id="nucleo" class=" form-control" type="text"
                            ...
                            <div class="input-group shadow-sm">
                                ...
                                <input name="proceso" id="proceso" class=" form-control" type="text"
					...
					<div class="input-group shadow-sm">
                        ...
                        <input name="precio" id="precio" value="<?php echo $row['precio']; ?>"
                            class="form-control" type="number" readonly="readonly" />
                    </div>
                    <hr>
                    ...
                    <div class="input-group shadow-sm">
                        ...
                        <input name="fecha" id="fecha" value="<?php echo $row['fecha']; ?>"
                            class="form-control" type="text" readonly="readonly" />
                    </div>
                    <hr>
                    </form>
