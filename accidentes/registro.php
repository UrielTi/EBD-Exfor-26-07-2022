    ...
    <div class="container-fluid border border-success bg-light">
        ...
        <div class="alert alert-success" role="alert">
            <center><strong>¡Hola!</strong> Asegúrate que la información que estas diligenciando esté actualizada hasta
                ...
                botón <i class="bi bi-pencil-fill"></i> o en "Editar Información" en la visualización del empleado <i class="bi bi-search"></i> , <strong>¡Muchas Gracias!</strong></center>
        </div>
        <hr>
        <?php
        ...
        <div class="panel panel-default">
            ...
            <form name="form1" id="form1" class="form-horizontal row-fluid" action="registro.php" method="POST">
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="nombres" id="nombres" class="form-control" type="text" required autocomplete="off" list="nombre" placeholder="Nombres del empleado">
                    <datalist id="nombre">
                        <?php
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="cedula" id="cedula" class="form-control" type="number" placeholder="Cédula" required readonly>
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="cargo1" id="cargo1" class="form-control" type="text" placeholder="Cargo del empleado" required readonly>
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="proceso1" id="proceso1" class="form-control" type="text" placeholder="Proceso" required readonly>
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="nucleo1" id="nucleo1" class="form-control" type="text" placeholder="Núcleo" required readonly>
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input id="hora_evento" name="hora_evento" type="time" class="form-control" placeholder="Ingresa la hora del evento" oninput="FranjaHoraria()">
                    <input id="franja" name="franja" type="text" class="form-control" placeholder="AM / PM" disabled>
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input id="año_evento" name="año_evento" type="number" class="form-control" placeholder="Ingresa el año del evento">
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" for="fecha_evento">(*) Fecha evento: </span>
                    <input name="fecha_evento" id="fecha_evento" class="form-control" type="date" required>
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" for="botonIncapacidad">(*) ¿Tiene incapacidad?: </span>
                    <select name="botonIncapacidad" id="botonIncapacidad" class="form-select" required>
                ...
                <div class="oculto">
                    <div class="input-group shadow-sm">
                        ...
                        <input name="fecha_inicio" id="fecha_inicio" class="form-control" type="date" placeholder="Fecha" oninput="FechaDias()">
                    </div>
                    <hr>

                    <div class="input-group shadow-sm">
                        <span class="input-group-text w-25" for="fecha_final">(*) Fecha final: </span>
                        <input name="fecha_final" id="fecha_final" class="form-control" type="date" placeholder="Fecha" oninput="FechaDias()">
                    </div>
                    <hr>

                    <div class="input-group shadow-sm">
                        <span class="input-group-text w-25" for="dias_incapacidad">(*) Dias de incapacidad: </span>
                        <input name="dias_incapacidad" id="dias_incapacidad" class="form-control" type="number" placeholder="Días de incapacidad" value="0" readonly>
                    </div>
                    <hr>
                </div>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <textarea name="descripcion" id="descripcion" class="form-control" type="text" rows="3" required placeholder="Descripcion"></textarea>
                </div>
                <hr>
