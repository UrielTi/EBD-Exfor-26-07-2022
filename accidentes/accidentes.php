...
$sql = mysqli_query($conn, "SELECT id, nombres, cedula, evento, lugar, parte_afectada, dias_incapacidad, fecha_evento FROM accidentes");
while ($row = mysqli_fetch_assoc($sql)) {
?>
                    <tr>
                        <td><?php echo $row['id'] ?></td>
                        <td><a onclick="loadData('bi bi-person-square','Visualización de accidentes','visualizar',<?php echo $row['id'] ?>)" href="" data-bs-toggle="modal" data-bs-target="#mimodal"><?php echo $row['nombres'] ?></a></td>
                        <td><?php echo $row['cedula'] ?></td>
                        <td><?php echo $eventos_acc[$row['evento']]?></td>
                        <td><?php echo $lugares[$row['lugar']] ?></td>
                        <td><?php echo $parte_afectada[$row['parte_afectada']] ?></td>
                        <td><?php echo $row['dias_incapacidad'] ?></td>
                        <td><?php echo $row['fecha_evento'] ?></td>
                        <td>
                        <a onclick="loadData('bi bi-person-square','Visualización de accidentes','visualizar',<?php echo $row['id'] ?>)" href="" data-toggle="tooltip" title="Ver" class="btn btn-sm btn-sm-info" data-bs-toggle="modal" data-bs-target="#mimodal"> <i class="bi bi-search"></i> </a>
