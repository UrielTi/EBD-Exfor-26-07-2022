        ...
        <div class="panel panel-default">
            ...
            <form name="form1" id="form1" class="form-horizontal row-fluid" action="update-edit.php" method="POST">
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="id" id="id" class="form-control" type="text" required autocomplete="off" value="<?php echo $row['id'] ?>" readonly>
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="cargo" id="cargo" class="form-control" type="hidden" required value="<?php echo $row['cargo'] ?>" readonly>
                    <input class="form-control" type="text" required value="<?php echo $cargos[$row['cargo']] ?>" readonly>
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input class="form-control" type="text" required readonly value="<?php echo $procesos[$row['proceso']] ?>">
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input class="form-control" type="text" required readonly value="<?php echo $nucleos[$row['nucleo']] ?>">
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <label class="input-group-text w-25" for="supervisor">Supervisor: </label>
                    <input class="form-control" type="hidden" id="supervisor" name="supervisor" value="<?php echo $row['supervisor'] ?>" readonly>
                    <input class="form-control" type="text" value="<?php echo $supervisores[$row['supervisor']] ?>" readonly>
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <label class="input-group-text w-25" for="hora_evento">Hora del Evento: </label>
                    <input class="form-control" type="time" id="hora_evento" name="hora_evento" value="<?php echo $row['hora'] ?>" oninput="FranjaHoraria">
                    <input class="form-control" type="text" id="franja" name="franja" value="<?php echo ($row['hora'] >= '12:00') ? 'PM' : 'AM'; ?>" readonly>
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input id="año_evento" name="año_evento" type="number" class="form-control" placeholder="Ingresa el año del evento" value="<?php echo $row['año'] ?>">
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" for="fecha_evento">Fecha evento: </span>
                    <input name="fecha_evento" id="fecha_evento" class="form-control" type="date" required oninput="FechaDias()" value="<?php echo $row['fecha_evento'] ?>">
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" for="fecha_final">Fecha final: </span>
                    <input name="fecha_final" id="fecha_final" class="form-control" type="date" required oninput="FechaDias()" value="<?php echo $row['fecha_final'] ?>">
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" for="dias_incapacidad">Dias de incapacidad: </span>
                    <input name="dias_incapacidad" id="dias_incapacidad" class="form-control" type="number" value="<?php echo $row['dias_incapacidad'] ?>">
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <textarea name="descripcion" id="descripcion" class="form-control" type="text" rows="3" required placeholder="Descripcion"><?php echo $row['descripcion']; ?></textarea>
                </div>
                <hr>
