...
include("../cond/todo.php");?>
        <div class="alert alert-success" role="alert">
            <center><strong>Nota:</strong> Si la información que ves aquí es errónea o si está desactualizada, puedes modificarla
                usando el botón de <strong>"<i class="bi bi-pencil-square"></i> o en "Editar
                    Información"</strong>.</center>
        </div>
        <hr>
        <?php
            $cedula = intval($_GET['id']);
			$sql = mysqli_query($conn, "SELECT * FROM ausentismo WHERE cedula='$cedula'");
        ...
        <div class="panel panel-default">
            ...
            <form name="form1" id="form1" class="form-horizontal row-fluid" action="visualizar.php" method="GET">
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="cargo" id="cargo" value="<?php echo $cargos[$row['cargo']] ?>" class="form-control "
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="proceso" id="proceso" value="<?php echo $procesos[$row['proceso']] ?>" class=" form-control "
                        type="text" readonly="readonly">
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="nucleo" id="nucleo" value="<?php echo $nucleos[$row['nucleo']] ?>" class="form-control "
                        type="text" readonly="readonly">
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="eps" id="eps" value="<?php echo $epss[$row['eps']] ?>" class="form-control " type="text"
                        readonly="readonly">
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="mes_evento" id="mes_evento" value="<?php echo $meses[$row['mes_evento']] ?>"
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="fecha_inicio" id="fecha_inicio" value="<?php echo $row['fecha_inicio']; ?>"
                        class=" form-control " type="text" readonly="readonly" />
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="fecha_final" id="fecha_final" value="<?php echo $row['fecha_final']; ?>"
                        class=" form-control " type="text" readonly="readonly">
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="dias_ausentismo" id="dias_ausentismo" value="<?php echo $row['dias_ausentismo']; ?>"
                        class=" form-control " type="text" readonly="readonly">
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="prorroga" id="prorroga" value="<?php echo $prorrogas[$row['prorroga']] ?>" class=" form-control "
                        type="text" readonly="readonly">
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="dx" id="dx" value="<?php echo $row['dx']; ?>" class="form-control" type="text"
                        readonly>
                    <textarea name="diagnostico" id="diagnostico" class="form-control" type="text" rows="1" 
                        required readonly><?php echo $row['diagnostico'] ?></textarea>
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <textarea name="descripcion" id="descripcion" class=" form-control " type="text" 
                        readonly="readonly"><?php echo $row['descripcion']; ?></textarea>
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" for="evento">Tipo de Evento: </span>
                    <input name="evento" id="evento" value="<?php echo $eventos[$row['evento']] ?>" class="form-control "
                        type="text" readonly="readonly">
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="peligro_aso" id="peligro_aso" value="<?php echo $peligros[$row['peligro_aso']] ?>"
                        class="form-control " type="text" readonly="readonly">
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="sve" id="sve" value="<?php echo $programas[$row['sve']] ?>" class="form-control " type="text"
                        readonly="readonly">
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="estado" id="estado" value="<?php echo $estados_aus[$row['estado']] ?>" class="form-control "
                        type="text" readonly="readonly">
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" for="estado_inc">Estado incapacidad: </span>
                    <input name="estado_inc" id="estado_inc" value="<?php echo $estadosEmpleado[$row['estado_incapacidad']] ?>" class="form-control "
                        type="text" readonly="readonly">
                </div>
                <hr>
