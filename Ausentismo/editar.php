    ...
    <div class="container-fluid border border-success bg-light">
        ...
        <div class="panel panel-default">
            ...
            <form name="form1" id="form1" class="form-horizontal row-fluid" action="update-edit.php" method="POST">
                ...
                <input class="form-control" type="hidden" name="id" id="id" value="<?php echo $row['id']; ?>" required readonly>

                <div class="input-group shadow-sm">
                    <label for="mes_evento" class="input-group-text w-25">(*) Mes del Evento:</label>
                    <input class="form-control" type="hidden" name="mes_evento" id="mes_evento" required value="<?php echo $row['mes_evento'] ?>" readonly>
                    <input class="form-control" type="text" required value="<?php echo $meses[$row['mes_evento']] ?>" readonly>
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" id="nombres">(*) Nombres: </span>
                    <input class="form-control" type="text" name="nombres" id="nombres" value="<?php echo $row['nombres']; ?>" required readonly>
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" id="cedula">(*) Cédula: </span>
                    <input class="form-control" type="number" name="cedula" id="cedula" value="<?php echo $row['cedula']; ?>" required readonly>
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" for="cargo">(*) Cargo: </span>
                    <input class="form-control" name="cargo" id="cargo" type="hidden" value="<?php echo $row['cargo'] ?>" required readonly>
                    <input class="form-control" value="<?php echo $cargos[$row['cargo']] ?>" required readonly>
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" for="proceso">(*) Proceso: </span>
                    <input class="form-control" name="proceso" id="proceso" type="hidden" value="<?php echo $row['proceso']; ?>" required readonly>
                    <input class="form-control" value="<?php echo $procesos[$row['proceso']]; ?>" required readonly>
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" for="nucleo">(*) Núcleo: </span>
                    <input class="form-control" name="nucleo" id="nucleo" type="hidden" value="<?php echo $row['nucleo']; ?>" required readonly>
                    <input class="form-control" value="<?php echo $nucleos[$row['nucleo']]; ?>" required readonly>
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" for="eps">(*) EPS: </span>
                    <input class="form-control" name="eps" id="eps" type="hidden" value="<?php echo $row['eps']; ?>" required readonly>
                    <input class="form-control" value="<?php echo $epss[$row['eps']]; ?>" required readonly>
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" for="fecha_inicio">(*) Fecha de Inicio: </span>
                    <input name="fecha_inicio" value="<?php echo $row['fecha_inicio']; ?>" id="fecha_inicio" class=" form-control" oninput="FechaDias()" type="date" required readonly>
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" for="fecha_final">(*) Fecha Final: </span>
                    <input name="fecha_final" value="<?php echo $row['fecha_final']; ?>" id="fecha_final" type="date" class="form-control" oninput="FechaDias()" required readonly>
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="dias_ausentismo" value="<?php echo $row['dias_ausentismo']; ?>" id="dias_ausentismo" class=" form-control" type="number" required readonly>
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm" id="diagnosticoOculto">
                    ...
                    <textarea name="diagnostico" id="diagnostico" class="form-control" type="text" placeholder="Diagnóstico" rows="1" required readonly><?php echo $row['diagnostico'] ?></textarea>
                </div>
                <hr>

                <div class="input-group shadow-sm" id="descripcionOculta">
                    <span class="input-group-text w-25" for="descripcion">(*) Descripción: </span>
                    <textarea name="descripcion" value="<?php echo $row['descripcion']; ?>" id="descripcion" class="form-control" type="text" rows="3" required><?php echo $row['descripcion'] ?></textarea>
                </div>
                <hr>
