        ...
        <div class="panel panel-default">
            ...
            <form name="form1" id="form1" class="form-horizontal row-fluid" action="registro.php" method="POST">
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="nombres" id="nombres" class="form-control" type="text" required autocomplete="off" list="nombre" placeholder="Ingrese el nombre del empleado">
                    <datalist id="nombre">
                        <?php
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="eps" id="eps" class="form-control" type="hidden" required readonly>
                    <input name="eps1" id="eps1" class="form-control" type="text" placeholder="EPS del Empleado" required readonly>
                </div>
                <hr>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <input name="fecha_inicio" id="fecha_inicio" class="form-control" type="date" placeholder="Fecha de Inicio" oninput="FechaDias()" required>
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" for="fecha_final">(*) Fecha Final: </span>
                    <input name="fecha_final" id="fecha_final" placeholder="Fecha Final" type="date" class="form-control" oninput="FechaDias()" required>
                </div>
                <hr>

                <div class="input-group shadow-sm">
                    <span class="input-group-text w-25" for="dias_ausentismo">(*) Dias de ausentismo: </span>
                    <input name="dias_ausentismo" id="dias_ausentismo" class="form-control" type="number" placeholder="Días ausentismo" readonly>
                </div>
                <hr>
                ...
                <div class="oculto">
                    <div class="input-group shadow-sm">
                        ...
                        <input name="dx" id="dx" class="form-control" value="*" type="text" placeholder="DX" list="listaDX" autocomplete="off">
                        <datalist id="listaDX">
                            <?php
                        ...
                        <textarea name="diagnostico" id="diagnostico" class="form-control" type="text" placeholder="Diagnóstico" rows="1" required readonly>*</textarea>
                    </div>
                    <hr>
                </div>
                ...
                <div class="input-group shadow-sm">
                    ...
                    <textarea name="descripcion" id="descripcion" class="form-control" type="text" rows="3" required placeholder="Ingrese la descripcion">*</textarea>
                </div>
                <hr>
