<?php
// Convertir el consecutivo 1 - 9 a octal
if ($select_consecutivo >= '1' && $select_consecutivo <= '9') {
    $consecutivo = sprintf("%02d", $input_consecutivo);
} else {
    $consecutivo = $input_consecutivo;
}
// Generar codigo con inputs
$codigo = $input_proceso .'-'. $input_tipo .'-'. $consecutivo;
// Guardar correctamente el proceso
if ($select_proceso == '1') {
...
// Guardar correctamente el tipo de documento
if ($select_tipo == '1') {
    $tipo = 'FORMATO';
}
